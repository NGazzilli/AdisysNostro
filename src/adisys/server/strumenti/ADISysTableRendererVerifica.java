...
import adisys.server.business_tier.InterventoCompleto;
...
public class ADISysTableRendererVerifica extends DefaultTableCellRenderer  {
	...
	private static final String VALORE_OK = InterventoCompleto.StatoVerifica.verificaOK.toString();
	private static final String VALORE_KO = InterventoCompleto.StatoVerifica.anomalia.toString();;
	private static final String VALORE_NULL = InterventoCompleto.StatoVerifica.nonVerificato.toString();;
